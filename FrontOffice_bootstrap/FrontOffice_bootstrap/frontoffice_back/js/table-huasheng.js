    (function ($) {  
        $.fn.extend({  
            "alterBgColor": function (options) {  
                ...
                //样式1  
                if (options.style == "1") {  
                    $("tbody>tr", this).live('click',function () { $(this).toggleClass(options.selected); });  
                }  
                ...
                if (options.style == "4") {  
                    //第一列 为多选  
                    $('tbody>tr td:first-child', this).live('click',function () {  
                    ...
                    //其他列 为单选  
                    $('tbody>tr td:not(:first-child)', this).live('click',function () {  
                        var p = $(this).parents("tr");  
